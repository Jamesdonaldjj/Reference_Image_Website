import { createTheme, makeStyles, Typography } from "@mui/material";
  ...
  return (
      <Box sx={{ width: '100%', height: '100%' }}>
          ...
          <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Button sx={{ mt: 4 }} variant="contained" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
              Explore Gallery
            </Button>
          </Box>
      </Box>
